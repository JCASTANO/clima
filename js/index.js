...
(function() {
	...
	console.log(localStorage.computador);
	var API_WORLDTIME_KEY = "158e7eefe2607a403ae398974e05a";
	var API_WORLDTIME 	  = "https://api.worldweatheronline.com/free/v2/tz.ashx?format=json&key="+ API_WORLDTIME_KEY + "&q=";
	var API_WEATHER_KEY   = "f0fc27539ba77bed8159c437f882d82f";
	...
	{
		console.log(API_WORLDTIME + $(nombreNuevaCiudad).val());
